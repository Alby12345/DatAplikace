...
create or replace view VIEW_Cust_With_More_Accs as
  select IdCust from CustAccs group by IdCust having count(*) > 1;
...
create or replace view VIEW_Accs_With_More_Cust as
  select IdAcc from CustAccs group by IdAcc having count(*) > 1;
